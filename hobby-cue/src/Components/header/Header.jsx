    ...
    <Navbar expand="lg" className="bg-body-tertiary navbar">
      <Container fluid>
        <Navbar.Brand className="logo" href="#">
          <Image style={{ marginLeft: "50px" }} width={186} src={logo} alt="" />
        </Navbar.Brand>
          ...
          >
            <Form className="d-flex searcharea">
              <Form.Control
                ...
                aria-label="Search"
              />
              <Button variant="outline-success searchbtn">
                <i className="bi bi-search"></i>
              </Button>
            </Form>
            <div className={`icons ${isMobile ? "justify-content-start" : ""}`}>
              <Nav.Link className="home" href="#action1">
                <i
                  className="bi bi-compass-fill text"
